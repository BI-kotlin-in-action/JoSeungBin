fun w(a: Int, b: Int, c: Int, dp: Array<Array<Array<Int>>>): Int {
    when {
        ...
        a >= b || b >= c-> {
            dp[a][b][c] = (w(a - 1, b, c, dp) + w(a - 1, b - 1, c, dp)
                    + w(a - 1, b, c - 1, dp) - w(a - 1, b - 1, c - 1, dp))
            return dp[a][b][c]
        }
...
fun main() {
    val dp = Array(21) { Array(21) { Array<Int>(21, {0}) } }
    while (true) {
